...
<div class="container">
    <div class="row">        
        <div class="col-md-12">
				<div class="heading">
			        <h5>Detail Event</h5>
			        <a href="<?php echo base_url();?>member/event" class="btn btn-info btn-sm pull-right"><span class="glyphicon glyphicon-arrow-left"></span></a>
			    </div>
...
<form action="<?php echo base_url();?>member/enroll" method="POST" accept-charset="utf-8">
<?php
  if (!$kelas) { ?>
 ...
 $no=0; foreach ($kelas as $key => $value) { ?>
        <div class="panel panel-default">
            ...
            <div class="col-md-10">
              ...
              <div class="col-md-2">
                <input  type="checkbox" id="pilih"  class="pull-right chk" value="<?php echo $value['id'] ?>" name="id_kelas">
              </div>
            </div>
            </div>
  ...
  <?php $no++; } }?>                 
        ...
        <?php
        if (!$kelas) {}else{ ?>
				<button type="submit" class="btn btn-sm btn-info btn-flat" >Submit</button>
        <?php }?>
