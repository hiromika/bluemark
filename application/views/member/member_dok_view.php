                        ...
                        <!--         <div class="ribbon new">
                            ...
                            <div class="col-sm-6">
                                <div class="box">
                                        ...
                                        <p class="text-center">
                                            <?php if ($cek['status'] == 0 && $cek['expired'] > date('Y-m-d H:i:s')){ ?>
                                                <button type="button" data-target="#info" data-toggle="modal" class="btn btn-template-main">Download</button>                                          
                                            <?php } elseif($cek['expired'] < date('Y-m-d H:i:s')){?>
                                            ...
                                            <?php } elseif($cek['status'] == 1 && $cek['exp_down'] > date('Y-m-d H:i:s')) { ?>
                                                <a href="<?php echo base_url();?>member/download/<?php echo $cek['id_transaksi'];?>" type="button" class="btn btn-xs btn-template-main">Download</a>
                                            <?php } else{ ?>
                                                <button type="button" class="btn btn-template-main" data-toggle="modal" data-target="#buy"><i class="fa fa-shopping-cart"></i>Beli</button>
                                            <?php } ?>
