    ...
    <div class="col-md-12">
      ...
      <div class="col-md-9">
        ...
        <div class="col-md-10">
            ...
            <form action="<?php echo base_url()?>member/EditUserPro" method="POST" class="form-horizontal" accept-charset="utf-8">
              <input type="text" name="id" value="<?php echo $this->session->userdata('idAuth');?>" hidden placeholder="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                  <textarea name="alamat" required="" class="form-control"><?php echo $user['alamat'] ?></textarea>                  
                  </div>
                </div>
                <div class="form-group">
                ...
                <a href="<?php echo base_url();?>member/DetailUser/<?php echo $this->session->userdata('idAuth')?>" title="Back" class="btn btn-warning btn-sm btn-flat pull-right" style="margin: 3px;">Back</a>
                <a href="<?php echo base_url();?>member/DetailUser/<?php echo $this->session->userdata('idAuth')?>" title="batal" class="btn btn-success btn-sm btn-flat pull-right" style="margin: 3px;">Batal</a>
