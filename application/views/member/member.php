                ...
                <div class="heading" style="margin-bottom: 10px;">
                 ...
                 <div class="homepage owl-carousel">
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="<?php echo base_url();?>member/DetailEvent/<?php echo $value['id']; ?>" title=""><img style="width:100%; height: 250px;" src="<?php echo base_url().$value['gambar'];?>" alt="" class="img-responsive"></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>   
          ...
          <?php foreach ($forum as $key => $value) { ?>
            <tr>
              ...
              <a href="<?php echo base_url();?>member/viewForum/<?php echo $value['idf'];?>" title="read more"><h5><?php echo $value['judul_forum'];?> </h5></a>
                <p> <i> By</i> : <u><?php echo $value['nama'];?></u> | <?php echo date('M d, Y H:i a',strtotime($value['tgl_forum'])); ?></p>
              </blockquote>
              </td>
