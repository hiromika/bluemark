                    ...
                    <div class="col-sm-9">
                        ...
                        <?php foreach ($book as $key => $value) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="/dashboard/ebookView/<?php echo $value['iddok'] ?>">
                                            <img src="<?php echo base_url().$value['image1']; ?>" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3 style="margin-bottom: 0 !important;"><a href="/dashboard/ebookView/<?php echo $value['iddok'] ?>"><?php echo $value['judul_dok'] ?></a></h3>

                                        <p><a href="/dashboard/ebookView/<?php echo $value['iddok'] ?>" class="btn btn-sm btn-template-main">View detail</a></p>
