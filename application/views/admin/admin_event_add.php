                ...
                <div style="overflow-x:auto;">
                  <form action="<?php echo base_url();?>admin/inputEvent" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="judul" value="" placeholder="Judul Event" required="">
                    </div> 

                    <div class="form-group">
                        <label for="gambar event">Gambar Event :</label>
                        <input type="file" name="gambar" onchange="readURL(this);" class="form-control" required="">
                        <img src="" id="blah" alt="" class="img-thumbnail" >
                    </div>
