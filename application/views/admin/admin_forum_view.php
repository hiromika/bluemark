...
<div class="container">
  <div class="row">        
    <div class="col-md-12">
    <div class="heading">
     <a href="<?php echo base_url();?>admin/forum" class="btn btn-info btn-sm pull-right"><span class="glyphicon glyphicon-arrow-left"></span></a>
    </div>
	  	...
	  	<p class="reply pull-right" style="margin-bottom: 0px;"><a href="<?php echo base_url();?>admin/editForum/<?php echo $forum['idf']; ?>"><i class="fa fa-edit"></i>Edit</a></p>		
	  	<?php } else{} ?>
				...
				<table class="table table-bordered" >
			  		...
			  		<?php foreach ($komen as $key => $value) { ?>
			  			<tr class="info">
			  				...
			  				<a href="<?php echo base_url();?>admin/DelKomen/<?php echo $value['id'].'/'.$forum['idf']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-xs btn-danger pull-right" title="Delete">Delete</a>
			  				</td>
			  			...
			  			<tr>
						  	...
						  	<p class="reply pull-right" style="margin-bottom: 0px;"><a href="<?php echo base_url();?>admin/editKomen/<?php echo $value['id'].'/'.$forum['id']; ?>"><i class="fa fa-edit"></i>Edit</a></p>		
						  	<?php } else{} ?>
			  				</td>
			  				<td style="display: none;"></td>
			  			</tr>
