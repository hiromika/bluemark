        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url();?>admin/menKelas">List Kelas</a></li>
                    <li>Edit Kelas</li>
                </ul>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
                ...
                <div>
                  	<form action="<?php echo base_url();?>admin/EditKelas" class="form form-horizontal" method="post" enctype="multipart/form-data">
                    <input hidden="" type="text" name="idk" value="<?php echo $kelas['idk']; ?>">        
					<div class="form-group">
						...
						<select name="event" class="form-control" required="">
							...
							<?php 
								...
								<option <?php if ($kelas['ide']==$value['id']) {
                                    echo "selected";
                                } ?>  value="<?php echo $value['id']; ?>"><?php echo $value['judul_event']; ?></option>
							<?php 	
								}
							?>
						</select>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
						<input class="form-control" type="text" name="kelas" value="<?php echo $kelas['kelas'] ?>"  placeholder="Nama Kelas">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<select name="instruktur" class="form-control" required="">
							...
							<?php 
								...
								<option  <?php if ($kelas['idu']==$value['id']) {
                                    echo "selected";
                                } ?>  value="<?php echo $value['id']; ?>"><?php echo $value['nama']; ?></option>
							<?php 	
								}
							?>
						</select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                        <input class="form-control" type="number" name="sesi" value="<?php echo $kelas['jumlah_sesi']; ?>" placeholder="Jumlah sesi" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                        <input class="form-control" type="number" name="kuota" value="<?php echo $kelas['kuota']; ?>" placeholder="Maksimum Peserta" required="">
                        </div>
                    </div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
						<input class="form-control" type="text" name="tgl" value="<?php echo date('d-m-y',strtotime($jadwal['tgl_kelas'])); ?>" id="date1" placeholder="Tanggal Mulai Kelas" required="">
						</div>
					</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                        <input type="text" name="jam_s" value="<?php echo $jadwal['jam_mulai']; ?>" class="form-control" id="jam1" placeholder="Start" required=""> 
                        </div>
                        <div class="col-xs-3">
                        <input type="text" name="jam_e" value="<?php echo $jadwal['jam_akhir']; ?>" class="form-control" id="jam2" placeholder="End" required=""> 
                        </div>
                    </div>
