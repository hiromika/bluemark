        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url();?>admin/menDok">List Dokumen</a>
                    </li>
                    <li>Edit Dokumen</li>
                </ul>
    ...
    <div class="heading">
        ...
        <div class="tabs">
            <ul class="nav nav-pills nav-justified">
                <li class="active"><a href="#tab2-1" data-toggle="tab" aria-expanded="true">Edit Detail</a>
                </li>
                <li class=""><a href="#tab2-2" data-toggle="tab" aria-expanded="false">Edit Gambar</a>
                </li>
            </ul>
            <div class="tab-content tab-content-inverse" style="padding-bottom: 50px !important; ">
                <div class="tab-pane active" id="tab2-1">
                    <form action="<?php echo base_url();?>admin/dokEditText" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                        <input  style="display: none;" type="text" name="id" value="<?php  echo $dok['iddok']; ?>" placeholder="">
                        <div class="form-group">
                        <label for="">No Dokumen :</label>
                            <input class="form-control" type="text" name="no" value="<?php  echo $dok['no_dok']; ?>" placeholder="No Dokumen" required="">
                        </div>

                        <div class="form-group">
                        <label for="">Judul Dokumen :</label>
                            <input class="form-control" type="text" name="judul" value="<?php  echo $dok['judul_dok']; ?>" placeholder="judul Dokumen" required="">
                        </div>
                        ...
                        <label for="">Tahun Dokumen :</label>
                            ...
                            type = "number"
                            maxlength = "4"  name="tahun" value="<?php  echo $dok['tahun']; ?>" placeholder="Tahun Dokumen" required="">
                        </div>

                        <div class="form-group">
                        <label for="">Abstrak</label>
                            <textarea class="form-control" name="abstrak" placeholder="Abstrak" required=""><?php  echo $dok['abstrak']; ?></textarea>
                        </div>

                        <div class="form-group">
                        <label for="">Kata Kunci/keyword</label>
                            <textarea class="form-control" name="keyword" placeholder="Kata Kunci/keyword" required=""><?php  echo $dok['keyword']; ?></textarea>
                        </div>

                        <div class="form-group">
                        <label for="">Penulis :</label>
                            <input class="form-control" type="text" name="penulis" value="<?php  echo $dok['penulis']; ?>" placeholder="Penulis" required="">
                        </div>
                        ...
                        <label for="">Jenis Dokumen :</label>
                            <select class="form-control" name="dokumen" required="">
                                ...
                                <?php foreach ($jen as $key => $value) { ?>
                                    <option value="<?php echo $value['id'];?>" <?php echo ($dok['id_jen']==$value['id'])?"selected":""; ?>>
                        ...
                        <label for="">Kategori :</label>
                            <select class="form-control" name="kategori" required="">
                                ...
                                <?php foreach ($kat as $key => $value) { ?>
                                    <option value="<?php echo $value['id'];?>" <?php echo ($dok['id_kat']==$value['id'])?"selected":""; ?>>
                        ...
                        <label for="">Harga Satuan:</label>
                            <input class="form-control" type="number" name="harga" value="<?php  echo $dok['harga']; ?>" placeholder="Harga" required="">
                        </div>

                        <div class="form-group">
                        <button type="submit" class="btn btn-template-main pull-right btn-flat form-control" title="Submit">Submit</button>
                        </div>
                ...
                <div class="tab-pane" id="tab2-2">
                   ...
                   <form action="/admin/dokEditImg" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                       	<input style="display: none;" type="text" name="id" value="<?php  echo $dok['iddok']; ?>" placeholder="">
                       	<input style="display: none;" type="text" name="dokumen" value="<?php  echo $dok['id_jen']; ?>" placeholder="">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                        <button type="submit" class="btn btn-template-main pull-right btn-flat form-control">Submit</button>
                        </div>
