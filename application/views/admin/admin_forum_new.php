...
<div class="container">
  <div class="row">        
    ...
    <input type="text" name="id" value="" hidden placeholder="">
	...
	<div class="form-group">
		...
		<textarea class="form-control" name="isi" id="textarea" placeholder=" Enter text ..." style=" height: 200px; " required=""></textarea>
	</div>
	...
	<button type="submit" class="btn btn-template-primary pull-right">Create</button>	
	</div>
    </form>
