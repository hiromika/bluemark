...
<div class="container">
    ...
    <div class="col-md-9">
    	<div class="heading">
    	<button class="btn btn-info btn-sm" type="button" data-toggle="modal"  data-target="#add">Add Jenis Dokumen</button>
    	</div>
    	<table class="table table-hover" id="kat">
            ...
            <?php foreach ($jenis as $key => $value) { ?>
                <tr>
                    ...
                    <a href="/admin/delJen/<?php echo $value['id']; ?>"  onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-xs btn-danger">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
  ...
  <div class="modal fade" id="add" >
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        ...
        <form action="/admin/addJen" method="post" accept-charset="utf-8">
            <div class="form-group">
            <input type="text" class="form-control" name="jenis" value="" placeholder="Nama Jenis Dokumen" required="">
            </div>
            <div class="form-group">
            <textarea class="form-control" name="keterangan" placeholder="Keterangan Jenis Dokumen" required=""></textarea>
            </div>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        ...
        <form action="/admin/addJen" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
            <input type="text" class="form-control" name="jenis" id="_kat" value="" placeholder="Nama Jenis Dokumen" required="">
            </div>
            <div class="form-group">
            <textarea class="form-control" name="keterangan" id="_ket" placeholder="Keterangan Jenis Dokumen" required=""></textarea>
            </div>
            <button type="submit" class="btn btn-primary btn-block btn-flat">Submit</button>
        </form>
        </div>
