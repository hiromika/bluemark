...
<div class="container">
  <div class="row">        
    ...
    <div class="heading">
        <h5>Edit Forum</h5>
      	<a href="<?php echo base_url();?>admin/viewForum/<?php echo $idf; ?>" class="btn btn-info btn-sm pull-right"><span class="glyphicon glyphicon-arrow-left"></span></a>
    </div>

    <form action="<?php echo base_url();?>admin/upKomen/<?php echo $idf;?>" method="POST" accept-charset="utf-8" class="" enctype="multipart/form-data">
