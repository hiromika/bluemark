		            			 ...
		            			 ?>	
		            				...
		            				<section class="post">
			                            <div class="row">
			                                ...
			                                <div class="col-md-8">
			                                    <h3><a href="<?php echo base_url();?>dashboard/DetailEvent/<?php echo $value['id']; ?>"><?php echo $value['judul_event']; ?></a></h3>
			                                    <div class="clearfix">
			                                 ...
			                                 <!--    <p class="intro"><?php echo $value['isi']; ?></p> -->
			                                    <p class="read-more"><a href="<?php echo base_url();?>dashboard/DetailEvent/<?php echo $value['id']; ?>" class="btn btn-template-main pull-right">Continue reading</a>
			                                    </p>
			                                </div>
			                            </div>
			                        </section>
