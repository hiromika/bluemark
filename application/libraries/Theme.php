...
require_once 'Theme/Providers/ThemeAdapter.php';
require_once 'Theme/Layout.php';
require_once 'Theme/View/Renderers/Template.php';
...
class Theme implements ThemeAdapter {
     ...
     */
    public function render($file = 'index', $data = array('content' => ''), $return = false) {
    ...
    protected function resolveViewPath($view) {
        $path = $this->themePath;
        if(is_file($this->themePath . $this->viewsFolder . '/' . $view . '.php' )){
            $path .= $this->viewsFolder;
        }
