<div class="easyui-layout" style="width:100%;height:430px;">
    <div data-options="region:'west',split:true" style="width:400px;">
        <table title="Role Management" id="dg_role" class="easyui-datagrid" style="border-collapse: collapse;height: 428px;" pagination="true" data-options="fitColumns:true,ctrlSelect:true,toolbar:'#tb_role',rownumbers:true,singleSelect:false,collapsible:true,url:'user/getRole',method:'get'">
            <thead>
    ...
    <div data-options="region:'center'">
        <table title="User Management" id="dg" class="easyui-datagrid" style="border-collapse: collapse;height: 428px;" pagination="true" data-options="fitColumns:true,ctrlSelect:true,toolbar:'#tb',rownumbers:true,singleSelect:false,collapsible:true,url:'user/get',method:'get'">
            <thead>
                <tr style="border-collapse: collapse">
                    <th data-options="field:'USER_LOGIN',resizable:false" width="15%">Login</th>
                    <th data-options="field:'USER_FULLNAME',resizable:false" width="15%">Full Name</th>
...
<div id="tb" style="padding:5px;height:auto">
    <div style="margin-bottom:5px">
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='add_user()' iconCls="icon-add" plain="true"> Add</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='edit_user()' iconCls="icon-edit" plain="true"> Edit</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='delete_user()' iconCls="icon-remove" plain="true"> Delete</a>
    <!-- </div>
    <div> -->
...
<div id="tb_role" style="padding:5px;height:auto">
    <div style="margin-bottom:5px">
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='add_role()' iconCls="icon-add" plain="true"> Add</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='edit_role()' iconCls="icon-edit" plain="true"> Edit</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick='delete_role()' iconCls="icon-remove" plain="true"> Delete</a>
        <!-- | Search : <input class="easyui-textbox" style="width:110px">
