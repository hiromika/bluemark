...
class Reports extends MY_Controller {
    ...
    public function __construct() {
        ...
        // $this->layout->addStyle('/assets/'.strtolower(__CLASS__).'/plugins/morris/morris.css');
        
        // $this->layout->addScript('/assets/'.strtolower(__CLASS__).'/plugins/morris/morris.min.js');
    ...
    public function summary(){
        $this->layout->set_header('Laporan');

        $content = $this->load->view('summary',array(),true);
