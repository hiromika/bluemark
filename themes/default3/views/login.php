...
<html>
    <head>
        ...
        <title>User Login | ERP Management System</title>
    ...
    <body class="hold-transition login-page">
    	...
    	<div id="login-slider" class="owl-carousel">
    		<div class="dm-owl-slide" style="background-image: url('<?php echo theme_path() ?>/img/bg1.jpg');">
				<div class="dm-owl-caption">
					<!-- <img src="<?php echo base_url('logo.jpg'); ?>" alt="logo" width="100px"> -->
					<h1>ERP</h1>
					<p class="margin">
			...
			<div class="dm-owl-slide" style="background-image: url('<?php echo theme_path() ?>/img/bg2.jpg');">
				<div class="dm-owl-caption">
					<h1>ERP</h1>
					<p class="margin">
						<a class="btn btn-danger" onclick="showLogin()"><i class="fa fa-lock"></i> &nbsp; Login</a>
