                    ...
                    <ul class="nav ace-nav pull-right">
                        ...
                        <li class="green">
                            ...
                            <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?php echo theme_path(); ?>/img/avatar.png" class="msg-photo" alt="Alex's Avatar" />
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?php echo theme_path(); ?>/img/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
                                        <span class="msg-body">
                                            <span class="msg-title">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?php echo theme_path(); ?>/img/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                                        <span class="msg-body">
                                            <span class="msg-title">
